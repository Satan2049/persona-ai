  ...
  assignTexture(key, texture, isColorTexture) {
    return __async3(this, null, function* () {
      const promise = (() => __async3(this, null, function* () {
        if (texture != null) {
          const assigned = yield this._parser.assignTexture(this._materialParams, key, texture);
          // ImageBitmap / decode failures resolve to null — don't crash on colorSpace.
          if (assigned == null) {
            console.warn(
          ...
          if (isColorTexture) {
            setTextureColorSpace(assigned, "srgb");
          }
        }
      }))();
